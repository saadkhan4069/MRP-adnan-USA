                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{__('Web Link')}}</label>
                                    <input type="text" name="web" value="{{$lims_supplier_data->web}}" placeholder="example.com" class="form-control">
                                </div>
                            </div>
                             <div class="col-md-12">
                            <div class="form-group">
                                <label>{{__('Notes')}}</label>
                                <textarea name="note" class="form-control" rows="3">{{$lims_supplier_data->note}}</textarea>
                            </div>
                        </div>
                            <div class="col-md-12">
