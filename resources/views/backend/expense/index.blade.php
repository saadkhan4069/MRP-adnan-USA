...
<section>
    <div class="container-fluid">
        ...
        @if(in_array("expenses-add", $all_permission))
            <button class="btn btn-info" data-toggle="modal" data-target="#expense-modal"><i class="dripicons-plus"></i> {{__('db.Add Expense')}}</button>
        @endif
    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="created_at" class="form-control date" placeholder="{{__('Choose date')}}"/>
                        </div>
                        <div class="col-md-6 form-group">
