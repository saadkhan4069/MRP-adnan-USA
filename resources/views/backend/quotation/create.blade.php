...
<div class="card-body">
<p class="italic"><small>{{__('db.The field labels marked with * are required input fields')}}.  & <strong>Lead Time Most Require Feilds Marked  </strong></small><br>
...
$("table.order-list").on("click", ".edit-product", function() {
   ...
   var lt_date  =  $(".ltd-date"+$(this).attr('data-no')).val()
   ...
   var ship_cost =  $(".ship_cost"+$(this).attr('data-no')).val()
       ...
       if (lt_date  !=""){ $('input[name="lt_date"]').val(lt_date ) }
...
cols += '<input type="hidden" class="purchase-unit" name="sale_unit[]" value="' + temp_unit_name[0] + '"/>';
...
cols += '<input type="hidden" class="ltd-date'+flag2+'" name="lt_date[]" />';
