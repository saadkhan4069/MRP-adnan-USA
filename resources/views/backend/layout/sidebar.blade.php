        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            <li><a href="#schedule" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-calendar"></i><span>Appointments</span></a>
                <ul id="schedule" class="collapse list-unstyled ">
                    <li id="schedule-booking-menu"><a href="{{route('schedule.public')}}"><i class="fa fa-calendar-plus-o"></i> Book Appointment</a></li>
                    <li id="schedule-my-menu"><a href="{{route('schedule.user-appointments')}}"><i class="fa fa-list-alt"></i> My Appointments</a></li>
                    @if(Auth::check() && Auth::user()->role_id <= 2)
                    <li id="schedule-admin-menu"><a href="{{route('schedule.admin')}}"><i class="fa fa-users"></i> Manage All Appointments</a></li>
                    @endif
                </ul>
            </li>
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{__('db.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @endif
                     @if($warehouse_permission_active)
                    <li id="production-menu"><a href="{{route('production.index')}}">{{__('Production')}}</a></li>
                    @endif
                    @if(\Auth::user()->role_id <= 2)
