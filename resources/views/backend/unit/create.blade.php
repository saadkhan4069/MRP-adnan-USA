...
<section>
    <div class="container-fluid">
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info"><i class="dripicons-plus"></i> {{__('db.Add Unit')}}</a>&nbsp;
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group operator">
                        <label>{{__('db.Operator')}}</label> <input type="text" name="operator" placeholder="{{ __('db.Enter your Name') }}" class="form-control" />
                    </div>
