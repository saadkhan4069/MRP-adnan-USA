        ...
        <div class="modal-body">
          <p class="italic"><small>{{__('db.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                ...
                {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => __('db.Type currency name')))}}
            </div>
            <div class="form-group">
                <label>{{__('db.Code')}} *</label>
                {{Form::text('code',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => __('db.Type currency code')))}}
            </div>
            <div class="form-group">
                <label>{{__('db.Exchange Rate')}} * <i class="dripicons-question" data-toggle="tooltip" title="{{__('db.If this is your default currency, the exchange rate must be 1')}}"></i></label>
                {{Form::text('exchange_rate',null,array('required' => 'required', 'class' => 'form-control', 'id' => 'add_exchange_rate', 'placeholder' => __('db.Type exchange rate')))}}
            </div>
            <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <p class="italic"><small>{{__('db.The field labels marked with * are required input fields')}}.</small></p>
            ...
            <div class="form-group">
                <label>{{__('db.Exchange Rate')}} * <i class="dripicons-question" data-toggle="tooltip" title="{{__('db.If this is your default currency, the exchange rate must be 1')}}"></i></label>
                {{Form::text('exchange_rate',null,array('required' => 'required', 'class' => 'form-control', 'id' => 'edit_exchange_rate', 'placeholder' => __('db.Type exchange rate')))}}
            </div>
