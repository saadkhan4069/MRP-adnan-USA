                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.posStore', 'method' => 'post']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4>
                                        🎉 Good news! We've introduced fully customizable <strong>Invoice Settings</strong>. Click the link below to explore this powerful new feature.
                                    </h4>

                                </div>
                                <div class="col-md-12 mt-2">
                                    <a href="{{ route('settings.invoice.index') }}" class="btn btn-primary">
                                        {{ __('db.Invoice Settings') }} <i class="dripicons-arrow-right ml-2"></i>
                                    </a>
                                </div>
                            </div>
                            <hr>
