                ...
                @if ($general_setting->site_logo)
                    @if (isset($show->active_logo_height_width) && $show->active_logo_height_width == 1)
                        <img src="{{ $invoice_settings->company_logo ? $invoice_settings->company_logo : url('logo', $general_setting->site_logo) }}"
                            style="max-width:{{ $invoice_settings->company_width ?? 130 }}px;margin:10px auto 0;">
                    @else
                        <img src="{{ $invoice_settings->company_logo ? $invoice_settings->company_logo : url('logo', $general_setting->site_logo) }}"
                            style="max-width:130px;margin:10px auto 0;">
                    @endif
                ...
                <tbody>
                    ...
                    @if ($totalDue)
                        <tr>
                            ...
                            <th style="width:40%">{{ number_format($totalDue, $general_setting->decimal, '.', ',') }}
                            </th>
                        </tr>
                    @endif
                    <tr>
