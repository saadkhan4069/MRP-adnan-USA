                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('template_name'))
                                            <small>
                                                <strong>{{ $errors->first('nametemplate_name') }}</strong>
                                            </small>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('numbering_type'))
                                            <small>
                                                <strong
                                                    class="text-danger">{{ $errors->first('number_of_digit') }}</strong>
                                            </small>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4 digit_number">
                                    <div class="form-group">
                                        <label><strong>{{ __('db.Number Of Digit (min-6, max-12)') }}*</strong></label>
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong>{{ __('db.Footer Title') }}</strong></label>
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong>{{ __('db.Preview Image') }}</strong></label>
