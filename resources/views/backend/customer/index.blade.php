...
<section>
    ...
    <div class="table-responsive">
        <table id="customer-table" class="table customer-list">
            <thead>
                <tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small>{{__('db.The field labels marked with * are required input fields')}}.</small></p>
           <p>{{__('db.The correct column order is')}} (customer_group*, name*, company_name, email, phone_number*, address*, city*, state, postal_code, country) {{__('db.and you must follow this')}}.</p>
            <div class="row">
                <div class="col-md-6">
