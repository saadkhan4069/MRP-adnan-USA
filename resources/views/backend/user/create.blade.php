                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{__('db.UserName')}} *</strong> </label>
                                    ...
                                    <div class="form-group">
                                        <label><strong>{{__('db.Password')}} *</strong> </label>
                                    ...
                                    <div class="form-group">
                                        <label><strong>{{__('db.Email')}} *</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><strong>{{__('db.Phone Number')}} *</strong></label>
                                    ...
                                    <div class="customer-section">
                                        <div class="form-group">
                                            <label><strong>{{__('db.Address')}} *</strong></label>
                                            <input type="text" name="address" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>{{__('db.State')}}</strong></label>
                                            <input type="text" name="state" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>{{__('db.Country')}}</strong></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{__('db.Company Name')}}</strong></label>
                                        <input type="text" name="company_name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label><strong>{{__('db.Role')}} *</strong></label>
                                    ...
                                    <div class="customer-section">
                                        <div class="form-group">
                                            <label><strong>{{__('db.Customer Group')}} *</strong></label>
                                        ...
                                        <div class="form-group">
                                            <label><strong>{{__('db.name')}} *</strong></label>
                                            <input type="text" name="customer_name" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>{{__('db.Tax Number')}}</strong></label>
                                            <input type="text" name="tax_number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>{{__('db.City')}} *</strong></label>
                                            <input type="text" name="city" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>{{__('db.Postal Code')}}</strong></label>
                                            <input type="text" name="postal_code" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group" id="biller-id">
                                        <label><strong>{{__('db.Biller')}} *</strong></label>
