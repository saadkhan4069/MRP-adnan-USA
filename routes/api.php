...
Route::group(['middleware' => $middleware], function () {
    ...
    Route::group(['middleware'=>['auth:sanctum','common','validate_mobile_token'], 'as' => 'api.'],function () {
    ...
    Route::get('inventory-movements', [InventoryMovementController::class, 'getInventoryMovementsApi']);
